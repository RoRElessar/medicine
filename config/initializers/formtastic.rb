...
# Set the default text field size when inputs is a string. Default is nil.
# Formtastic::FormBuilder.default_text_field_size = 50

# Set the default text area height when inputs is a text. Default is 20.
# Formtastic::FormBuilder.default_text_area_height = 5

# Set the default text area width when inputs is a text. Default is nil.
...
# for the text inside each @<option>@ tag or alongside each radio @<inputs>@. The first method
# that is found on the object will be used.
# Defaults to ["to_label", "display_name", "full_name", "name", "title", "username", "login", "value", "to_s"]
# Formtastic::FormBuilder.collection_label_methods = [
#   "to_label", "display_name", "full_name", "name", "title", "username", "login", "value", "to_s"]

# Specifies if labels/hints for inputs fields automatically be looked up using I18n.
...
# You can opt-in to Formtastic's use of the HTML5 `required` attribute on `<inputs>`, `<select>`
...
# By creating custom inputs class finder, you can change how inputs classes  are looked up.
